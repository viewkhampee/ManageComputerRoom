      ...
      <div class="main-panel">        
        ...
        <center><div class="row-center">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">แก้ไขประเภทงาน</h4>
                 
                  <?php
              $user = $_SESSION['mem_user'];
              $typeid = $_GET['id'];
              $re ="SELECT * FROM type_repair WHERE re_id = '$typeid'";
            $rep = mysqli_query($conn,$re);
            $repair = mysqli_fetch_array($rep);
    
  ?>
                  <form action="update_type.php" method="post" id="dateForm" enctype="multipart/form-data" > 
                  <div class="col-md-12 mb-4">
                
                      <label for="exampleInputUsername1">ชื่อประเภท</label>
                      <input style="border-radius: 30px;"  type="text" name="re_name"  value="<?php echo $repair['re_name']; ?>"  class="form-control" id="exampleInputUsername1" required>
                      <input style="border-radius: 30px;"  type="text" name="re_id" hidden value="<?php echo $typeid; ?>"  class="form-control" id="exampleInputUsername1" required>
                 
                    </div>
                    <div class="col-md-12 mb-4">
                      <label for="exampleInputEmail1">สถานะ</label>
                    <select style="border-radius: 30px;"  class="form-control text-center" name="status" >
                <option <?php if($repair['status'] == 1){echo 'selected';} ?> value="1" >พร้อมใช้งาน</option>
                <option <?php if($repair['status'] == 0){echo 'selected';} ?> value="0" >ไม่พร้อมใช้งาน</option>
                    ...
                    <a href="type_repair.php" class="btn btn-light mr-2">ย้อนกลับ</a>
