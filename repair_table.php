...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
            ...
            <div class="add-items d-flex px-3 mb-0">
              <form class="form w-100">
                <div class="form-group d-flex">
                  <input style="border-radius: 30px;" type="text" class="form-control todo-list-input"
      ...
      ;
      $nowdate = date("Y-m-d");
      $b = "SELECT * FROM repair WHERE status < 5 ORDER BY re_date ASC";
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    มีรายการแจ้งซ่อมทั้งหมด <b class="text-danger">
                      <?php echo $numq; ?>
                    </b> คิว
                  </p>
                          ...
                          <?php while ($comp = mysqli_fetch_array($ban)) {
                            ...
                            <tr>
                              <td class="align-middle">
                                ...
                                <img src="images/repair/<?php echo $comp['re_img']; ?>" class="avatar avatar-sm "
                                  alt="user1" style="border-radius: 10%;height: 40%;">

                              </td>

                              <td>
                                <?php echo $comp['re_user']; ?>
                              </td>

                              <td>
                                <?php echo $comp['re_name']; ?>
                              </td>
                              <td>
                                <?php echo $comstat['re_name']; ?>
                              </td>
                              ...
                              <td>
                                ...
                                <?php } elseif ($comp['status'] == 4) {
                                  ?> <b class="text-success"><i class="mdi mdi-account-check"></i> รอผู้ส่งคำร้องยืนยันรับของ
                                    1/2</b>
                              ...
                              <td>
                                <?php echo $comp['re_datesucc']; ?>
                              </td>
                              <td><a class="btn btn-info" href="repair_deatil.php?id=<?php echo $comp['re_id']; ?>"><i
                                    class="bi bi-pencil-fill"></i> เริ่มงาน</a>
