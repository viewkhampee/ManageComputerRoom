        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                <center><a href="type_insert.php"><button type="button" class="btn btn-dark" ><i class="icon-plus menu-icon"></i> เพิ่มประเภทข้อมูล </button></a></center></br>
                  <h4 co="card-title">ประเภทข้อมูล</h4>
                  <?php $co = "SELECT * FROM type_repair";
              ...
              ?>
                  <p class="card-description">
                    มีประเภททั้งหมด <b class="text-danger"><?php echo $comq; ?></b> อย่าง
                  </p>
        ...
        $("input").keyup(function () {
                      ...
                      while($comp = mysqli_fetch_array($com)){ 
                        ...
                        <tr>
                         ...
                         <?php } ?>
                          ...
                          <td><a href="type_edit.php?id=<?php echo $comp['re_id']; ?>"><button type="button" class="btn btn-info"><b>ปรับแต่ง</b></button></a></td>
          ...
          <a href="" id="notificationDropdown" href="#" data-toggle="dropdown"><button type="button" class="btn btn-danger count-indicator dropdown-toggle" ><b>ลบ</b></button></a>
            <a class="nav-link " id="notificationDropdown" href="#" data-toggle="dropdown">
              ...
              <a class="dropdown-item preview-item" href="del_type.php?id=<?php echo $comp['re_id']; ?>">
