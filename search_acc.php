    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php include 'server.php';
       ...
       die("Connection failed: " . $conn->connect_error);
              ...
              $b = "SELECT * FROM dd_member WHERE mem_user LIKE '%$searchquery%' AND mem_status <= 5 AND acc_state = 1 ORDER BY mem_status DESC";
                ...
                $.ajax({
                  ...
                  <div style="margin:20px auto; text-align: center;">
                      <form method="post" action="search_acc.php">
                          ...
                          <input style="border-radius: 30px;"  style="border-radius: 30px;"  type="text" name="search_text" id="search_box" class='search_box form-control text-center' value="<?php echo $_POST['search_text']; ?>" placeholder="***ป้อนชื่อผู้ใช้***"></br> 
                          <tr>
            ...
            <?php if ($user_record['mem_status'] == 1){ ?>
               ...
               <a class="dropdown-item preview-item" >
                 ...
                 <div class="preview-item-content">
                   <h6 class="preview-subject font-weight-normal text-danger">ไม่สามารถลบได้</h6>
                   <p class="font-weight-light small-text mb-0 text-muted">
                     ผู้ใช้ <?php echo $bank['mem_user']; ?>
                   </p>
                   <?php  }elseif($bank['mem_status'] == 1){ ?>
               <a class="dropdown-item preview-item" >
                 <div class="preview-thumbnail">
