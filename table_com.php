        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                <center><a href="comp_insert.php"><button type="button" class="btn btn-dark" ><i class="icon-plus menu-icon"></i> เพิ่มข้อมูลห้องคอมพิวเตอร์ </button></a></center></br>
                  <h4 co="card-title">ข้อมูลห้องคอมพิวเตอร์</h4>
                  <?php $co = "SELECT * FROM comp_state";
              ...
              ?>
                  <p class="card-description">
                    มีห้องคอมพิวเตอร์ทั้งหมด <b class="text-danger"><?php echo $comq; ?></b> ห้อง
                  </p>
        ...
        $("input").keyup(function () {
                ...
                <ul id="results" class="update">  
                    <table class="table">
                      ...
                      while($comp = mysqli_fetch_array($com)){ 
                        ...
                        $re = "SELECT * FROM comroom  WHERE room_id = '$idcom' AND status = 1";
          ...
          <a href="" id="notificationDropdown" href="#" data-toggle="dropdown"><button type="button" class="btn btn-danger count-indicator dropdown-toggle" ><b>ลบ</b></button></a>
            <a class="nav-link " id="notificationDropdown" href="#" data-toggle="dropdown">
              ...
              <a class="dropdown-item preview-item" href="del_room.php?id=<?php echo $comp['Id_comp']; ?>">
