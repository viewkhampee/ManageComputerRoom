...
?>       
        ...
        <?php
                        if($repair['status'] == 0){
                              ...
                              <button type="button" class="btn btn-info text-white" onclick="confirmBooking('2')">ยืนยันได้รับอุปกรณ์แล้ว</button>
                          ...
                          <?php  }elseif($repair['status'] == 2){
                            ...
                            <button type="button" class="btn btn-success" onclick="confirmBooking('3')">ยืนยันการซ่อมสำเร็จ</button>
                              <a href="repair_table.php" class="btn btn-dark">ย้อนกลับ</button></a></br>
                        <?php  }elseif($repair['status'] == 3){
                            ?>  <b  class="text-success"><i class="mdi mdi-check"></i> ซ่อมเสร็จแล้ว</b></br>
                        ...
                        <hr>
                    <h4 class="text-danger">** ยกเลิกคำร้อง **
               
               </h4>
                    <form action="cancel_repair.php" method="post" enctype="multipart/form-data"> 
                    <label for="exampleInputEmail1">หมายเหตุ</label>
                    <input style="border-radius: 30px;"  type="text" class="form-control" name="re_id" value="<?php echo $repairid; ?>" hidden required>
                    <input style="border-radius: 30px;"  type="text" class="form-control" name="status" value="9" hidden required>
                      <textarea style="border-radius: 30px;"  class="form-control" name="comment" rows="7"  placeholder="กรณีไม่สามารถซ่อมได้ให้ระบุเหตุผล" required><?php echo $repair['comment']; ?></textarea>
                       </div>
                    
                       <button type="submit" class="btn btn-danger mr-2">ยกเลิกคำร้องขอ</button>
