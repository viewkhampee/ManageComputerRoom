...
(function () {
    ...
    var global$2 = tinymce.util.Tools.resolve('tinymce.php.DomParser');

    var global$3 = tinymce.util.Tools.resolve('tinymce.php.Node');

    var global$4 = tinymce.util.Tools.resolve('tinymce.php.Serializer');
