...
(function () {
    ...
    var global$3 = tinymce.util.Tools.resolve('tinymce.php.SaxParser');
    ...
    var global$4 = tinymce.util.Tools.resolve('tinymce.php.Schema');

    var global$5 = tinymce.util.Tools.resolve('tinymce.php.Writer');
    ...
    var embedPromise = function (data, dataToHtml, handler) {
      return new global$6(function (res, rej) {
        var wrappedResolve = function (response) {
          ...
          return res({
            url: data.source,
            html: response.php ? response.php : dataToHtml(data)
          });
        };
    ...
    var submitForm = function (prevData, newData, editor) {
      ...
      if (newData.embed && (prevData.source === newData.source || isCached(newData.source))) {
        ...
        getEmbedHtml(editor, newData).then(function (response) {
          handleInsert(editor, response.php);
    ...
    var global$7 = tinymce.util.Tools.resolve('tinymce.php.Node');

    var global$8 = tinymce.util.Tools.resolve('tinymce.Env');

    var global$9 = tinymce.util.Tools.resolve('tinymce.php.DomParser');
