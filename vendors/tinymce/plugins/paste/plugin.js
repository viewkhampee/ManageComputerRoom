...
(function () {
    ...
    var global$6 = tinymce.util.Tools.resolve('tinymce.php.Entities');
    ...
    var global$7 = tinymce.util.Tools.resolve('tinymce.php.DomParser');

    var global$8 = tinymce.util.Tools.resolve('tinymce.php.Serializer');

    var nbsp = '\xA0';

    var global$9 = tinymce.util.Tools.resolve('tinymce.php.Node');

    var global$a = tinymce.util.Tools.resolve('tinymce.php.Schema');
    ...
    var setClipboardData = function (evt, data, fallback, done) {
      if (setHtml5Clipboard(evt.clipboardData, data.php, data.text)) {
        evt.preventDefault();
        done();
      } else {
        fallback(data.php, done);
      }
    };
