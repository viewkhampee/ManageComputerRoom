...
<link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  ...
  ?>
                  <form action="add_type.php" method="post" id="dateForm" enctype="multipart/form-data" > 
                  <div class="col-md-12 mb-4">
                
                      <label for="exampleInputUsername1">ชื่อประเภท</label>
                      <input style="border-radius: 30px;"  type="text" name="re_name"  class="form-control" id="exampleInputUsername1" required>
