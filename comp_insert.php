...
<link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
      ...
      <div class="main-panel">        
        ...
        <center><div class="row-center">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">เพิ่มข้อมูลห้องคอมพิวเตอร์</h4>
  ...
  ?>
                  <form action="add_comp.php" method="post" id="dateForm" enctype="multipart/form-data" > 
                  <div class="col-md-12 mb-4">
                
                      <label for="exampleInputUsername1">ชื่อประจำห้องคอมพิวเตอร์</label>
                      <input style="border-radius: 30px;"  type="text" name="comp_name"  class="form-control" id="exampleInputUsername1" required>
                 
                    </div>
                    <div class="col-md-12 mb-4">
                      <label for="exampleInputEmail1">สถานะ</label>
                    <select style="border-radius: 30px;"  class="form-control text-center" name="comp_status" >
                ...
                <option value="2" >เสีย</option>
                    ...
                    <div class="col-md-12 mb-4">
                      ...
                      <input style="border-radius: 30px;"  type="text" name="comp_plob"  class="form-control" id="exampleInputUsername1">
                    </div>
